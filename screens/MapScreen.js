...
const MapScreen = () => {
    ...
    const socket = io('http://192.168.8.138:5000'); // Replace with your backend URL
    const navigation = useNavigation(); // Use useNavigation

    useEffect(() => {
        axios.get('http://192.168.8.138:5000/restaurant-location') // Replace with your backend URL
            .then(response => {
